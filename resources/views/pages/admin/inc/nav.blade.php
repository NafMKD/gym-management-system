@php
    ...
    $navIsReception = $navRole === 'reception';
    $navIsAccountant = $navRole === 'accountant';
    $brandRoute = $navIsAdmin ? route('admin.home') : ($navIsAccountant ? route('accountant.home') : route('reception.home'));
    $brandLabel = $navIsAdmin ? __('Admin') : ($navIsAccountant ? __('Accountant') : __('Front desk'));
@endphp
<!-- Main Sidebar Container -->
<aside class="main-sidebar sidebar-dark-primary elevation-4">
    <!-- Brand Logo -->
    <a href="{{ $brandRoute }}" class="brand-link">
        <center><span class="brand-text font-weight-light">{{ $brandLabel }}</span></center>
    </a>
    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column nav-child-indent" data-widget="treeview" role="menu"
                ...
                @elseif($navIsAccountant)
                    <li class="nav-item">
                        <a href="{{ route('accountant.home') }}" class="nav-link {{ request()->routeIs('accountant.home') ? 'active' : '' }}">
                ...
                <li class="nav-item {{ request()->routeIs('admin.users*') ? 'menu-open' : '' }}">
                    ...
                    <ul class="nav nav-treeview">
                        ...
                        @endif
                        <li class="nav-item">
                            <a href="{{ route('admin.users.list') }}" class="nav-link {{ request()->routeIs('admin.users.list') || request()->routeIs('admin.users.view') || request()->routeIs('admin.users.edit') || request()->routeIs('admin.users.print') ? 'active' : '' }}">
                                <i class="fas fa-list nav-icon"></i>
                                <p>{{ $navIsAccountant ? __("User Reports") : __("Users List") }}</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                <li class="nav-item {{ request()->routeIs('admin.products*') || request()->routeIs('admin.merchandise*') ? 'menu-open' : '' }}">
                    <a href="#" class="nav-link {{ request()->routeIs('admin.products*') || request()->routeIs('admin.merchandise*') ? 'active' : '' }}">
                        ...
                        <p>
                            {{ $navIsAccountant ? __("Inventory & Sales") : __("Inventory") }}
                            <i class="right fas fa-angle-left"></i>
                        </p>
                    </a>
                    <ul class="nav nav-treeview">
                        ...
                        @if($navIsAdmin || $navIsAccountant)
                            <li class="nav-item">
                                <a href="{{ route('admin.products.list') }}" class="nav-link {{ request()->routeIs('admin.products.list') || request()->routeIs('admin.products.view') || request()->routeIs('admin.products.edit') || request()->routeIs('admin.products.print') ? 'active' : '' }}">
                                    <i class="fas fa-list nav-icon"></i>
                                    <p>{{ $navIsAccountant ? __("Product report") : __("Products") }}</p>
                                </a>
                            </li>
                        @endif
                        ...
                        <li class="nav-item">
                            <a href="{{ route('admin.merchandise.history') }}" class="nav-link {{ request()->routeIs('admin.merchandise.history') || request()->routeIs('admin.merchandise.history.print') ? 'active' : '' }}">
                                <i class="fas fa-receipt nav-icon"></i>
                                <p>{{ $navIsAccountant ? __("Sales report") : __("Sales history") }}</p>
                            </a>
                        </li>
                    </ul>
                </li>
                ...
                @if($navIsAdmin || $navIsAccountant)
                    <li class="nav-item">
                        <a href="{{ route('admin.invoices.list') }}" class="nav-link {{ request()->routeIs('admin.invoices*') ? 'active' : '' }}">
                            ...
                            <p>{{ $navIsAccountant ? __("Invoice report") : __("Invoices") }}</p>
                        </a>
                    </li>
                    ...
                    <li class="nav-item {{ request()->routeIs('admin.payments*') ? 'menu-open' : '' }}">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="{{ route('admin.payments.list') }}" class="nav-link {{ request()->routeIs('admin.payments.list') || request()->routeIs('admin.payments.view') || request()->routeIs('admin.payments.add') || request()->routeIs('admin.payments.print') ? 'active' : '' }}">
                                    <i class="fas fa-list nav-icon"></i>
                                    <p>{{ $navIsAccountant ? __("Payment report") : __("Payments List") }}</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.payments.revenue.list') }}" class="nav-link {{ request()->routeIs('admin.payments.revenue.list') || request()->routeIs('admin.payments.revenue.print') ? 'active' : '' }}">
