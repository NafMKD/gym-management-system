...
@section('header')
    @include('layouts.header', ['title' => 'Admin | Edit Staff'])
@endsection
...
@section('content')
    <x-content class="content">
        <x-card class="card-default" title="Staff Information" form="admin.staffs.update" form-update="{{$user->id}}" footer>
            <x-slot:headerTools>
