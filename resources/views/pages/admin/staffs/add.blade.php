...
@section('header')
    @include('layouts.header', ['title' => 'Admin | Add Staff'])
@endsection
...
@section('content')
    <x-content class="content">
        <x-card class="card-default" title="Staff Information" form="admin.staffs.store" footer>
            <div class="row">
